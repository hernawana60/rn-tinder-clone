    ...
    getDoc(doc(db, "users", userSwiped.id, "swipes", user.uid)).then(
      (documentSnapshot) => {
        if (documentSnapshot.exists()) {
          console.log(`Horray you MATCH with ${userSwiped.displayName}`);
            ...
            card ? (
              ...
              >
                ...
                <View
                  style={[
                    tw(
                      "absolute bottom-0 bg-white w-full justify-between items-center flex-row h-20 px-6 py-2 rounded-b-xl "
                    ),
                    styles.createShadow,
                  ]}
                >
              ...
              >
                <Text style={tw("font-bold pb-5")}>No More Picture</Text>
                <Image
                  style={tw(" h-20 w-20 ")}
                  height={100}
                  width={100}
